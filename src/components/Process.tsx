      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        >
          {processSteps.map((step, index) => (
            <li
              key={step.title}
              className="process-step will-3d border-b border-line py-8 sm:odd:border-r sm:px-6 sm:py-10 lg:border-r lg:last:border-r-0"
            >
              ...
              <p className="mt-3 text-base leading-relaxed text-muted">{step.detail}</p>
            </li>
          ))}
        </ol>
      </div>
